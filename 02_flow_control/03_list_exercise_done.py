...
print(lista)
print('Numero de veces que aparece el numero 2: ',lista.count(2))
...
original = [1, 2, 3]
copia = original[:]
copia_con_copy = original.copy()
referencia = original
original[0] = 10
print("Original:", original)
print("Copia con slicing:", copia)
print("Copia con copy():", copia_con_copy)
...
print("Lista ordenada sin diferenciar mayúsculas y minúsculas:", sorted_frutas)
print('----------')